...
spike_position[4] = [(60, 360), (60, 420), (180, 480), (180, 540), (240, 300), (360, 540), (480, 540), (540, 120), (540, 540), (600, 480), (600, 660)]
...
next_level = TextDisplay("Go to the next level!", "MyriadProLight.ttf", 45, (220, 300), (50, 205, 50))
complete = TextDisplay("Congratulations!", "MyriadProLight.ttf", 45, (230, 300), (50, 205, 50))
...
while exit_flag == False:
    ...
    for ev in event.get():
        ...
        if ev.type == MOUSEBUTTONDOWN:
            if retry.rect.collidepoint(mouse.get_pos()) and retrying == True:
                alive = True
                death_loop = True
                game_background.play()
                all_text = Group()
            ...
            elif next_level.rect.collidepoint(mouse.get_pos()) and winning == True:
                all_text = Group()
                Grouping_Sprites()
                game_background.play()
                character = Character(char_position[level])
    ...
    if spritecollideany(character, all_flag) and level < 4:
        ...
        victory = True
        death_history = TextDisplay("You have died {} times!".format(death_count), "MyriadProLight.ttf", 50, (170, 500), (255, 0, 255))
    ...
    if spritecollideany(character, all_flag) and level == 4:
        ...
        death_final = TextDisplay("You died a total of {} times!".format(death_count), "MyriadProLight.ttf", 50, (150, 500), (255, 0, 255))
        win = True
